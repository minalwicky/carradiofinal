...
<?php
 include('inc/dbConn.php');
  ...
  // Fetch image from database
    $query = mysqli_query($conn, "SELECT * FROM carsdetail WHERE approval='approved' AND (title='".$_SESSION['searchvalue']."' OR make='".$_SESSION['searchvalue']."' OR model='".$_SESSION['searchvalue']."')");
  ...
  <form method="POST">
  <button type="submit" id="like" name="submit36" style="
