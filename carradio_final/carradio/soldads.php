    ...
    <div class="container">
        ...
        <img src="LOGO_G.png" class="logo">
            ...
            <ul>
                ...
                <li><a  class="active" href="soldads.php">Liked vehicles</a></li>
          ...
          <br><br><br><br><br>
    <h1 style="color: black;">LIKED CAR ADVERTISEMENTS</h1>
...
session_start();
 include('inc/dbConn.php');
  ...
  $uname = $_SESSION['uname'];
    $query = mysqli_query($conn, "SELECT * FROM carsdetail WHERE sellername = '$uname' AND buyersname <> 'no' AND deleted = 'no' ");
